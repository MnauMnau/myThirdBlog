...
# Getting location of admin directory
ADMIN_DIR = BASE_DIR.rsplit('/',1)
ADMIN_DIR = os.path.join(ADMIN_DIR[0],'venv')
...
SECRET_KEY = 'pn8b%88usqfpr805io5cy*f!o)yv20ihjd)2l(b#di7rkgfkc8'
...
STATICFILES_DIRS = [os.path.join(ADMIN_DIR,'lib64/python3.6/site-packages/django/contrib/admin/static')]

STATIC_ROOT = os.path.join(BASE_DIR,'entries/static')
